  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-16 text-slate-100 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <p className="text-sm uppercase tracking-[0.35em] text-cyan-400">Watchlist</p>
        <h1 className="mt-3 text-4xl font-semibold sm:text-5xl">İzləmə siyahısı</h1>
        <div className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {movies.slice(1, 4).map((item) => (
